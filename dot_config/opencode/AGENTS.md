...
- Source: `~/Downloads/agent-skills-0.6.10` (see `agent-skills-install.json` for manifest). To update, re-copy `skills/*` + `references/*.md` and re-apply the two renames above.
